...
private:
	// Prevent copying - this class owns fCompletionStyle
								BAutoCompleter(const BAutoCompleter&);
			BAutoCompleter&		operator=(const BAutoCompleter&);
